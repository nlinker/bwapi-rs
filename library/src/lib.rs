...
pub mod ffi {
    ...
    unsafe extern "C++" {
        ...
        pub fn _game_getEvents(game: &Game) -> &EventList;
        ...
        pub fn setTextSize(self: Pin<&mut Game>, size: TextSize);
        pub fn _game_drawText(game: Pin<&mut Game>, ctype: CoordinateType, x: i32, y: i32, text: &str);
        pub fn drawBox(self: Pin<&mut Game>, ctype: CoordinateType, left: i32, top: i32, right: i32, bottom: i32, color: Color, isSolid: bool);
        pub fn drawTriangle(self: Pin<&mut Game>, ctype: CoordinateType, ax: i32, ay: i32, bx: i32, by: i32, cx: i32, cy: i32, color: Color, isSolid: bool);
        pub fn drawCircle(self: Pin<&mut Game>, ctype: CoordinateType, x: i32, y: i32, radius: i32, color: Color, isSolid: bool);
        pub fn drawEllipse(self: Pin<&mut Game>, ctype: CoordinateType, x: i32, y: i32, xrad: i32, yrad: i32, color: Color, isSolid: bool);
        pub fn drawDot(self: Pin<&mut Game>, ctype: CoordinateType, x: i32, y: i32, color: Color);
        pub fn drawLine(self: Pin<&mut Game>, ctype: CoordinateType, x1: i32, y1: i32, x2: i32, y2: i32, color: Color);
    }
    // endregion
    ...
    // extern "C++" {
    //     fn exists() -> bool;
    //     fn getAcidSporeCount() -> i32;
    //     fn getAddon() -> Unit;
    //     fn getAirWeaponCooldown() -> i32;
    //     fn getAngle() -> double;
    //     fn getBottom() -> i32;
    //     fn getBuildType() -> UnitType;
    //     fn getBuildUnit() -> Unit;
    //     fn getCarrier() -> Unit;
    //     fn getClosestUnit(pred: UnitFilter, radius: i32) -> Unit;
    //     fn getDefenseMatrixPoints() -> i32;
    //     fn getDefenseMatrixTimer() -> i32;
    //     fn getDistanceP(target: Position) -> i32;
    //     fn getDistanceU(target: Unit) -> i32;
    //     fn getEnergy() -> i32;
    //     fn getEnsnareTimer() -> i32;
    //     fn getGroundWeaponCooldown() -> i32;
    //     fn getHatchery() -> Unit;
    //     fn getHitPoints() -> i32;
    //     fn getID() -> i32;
    //     fn getInitialHitPoints() -> i32;
    //     fn getInitialPosition() -> Position;
    //     fn getInitialResources() -> i32;
    //     fn getInitialTilePosition() -> TilePosition;
    //     fn getInitialType() -> UnitType;
    //     fn getInterceptorCount() -> i32;
    //     fn getInterceptors() -> Unitset;
    //     fn getIrradiateTimer() -> i32;
    //     fn getKillCount() -> i32;
    //     fn getLarva() -> Unitset;
    //     fn getLastAttackingPlayer() -> Player;
    //     fn getLastCommand() -> UnitCommand;
    //     fn getLastCommandFrame() -> i32;
    //     fn getLeft() -> i32;
    //     fn getLoadedUnits() -> Unitset;
    //     fn getLockdownTimer() -> i32;
    //     fn getMaelstromTimer() -> i32;
    //     fn getNydusExit() -> Unit;
    //     fn getOrder() -> Order;
    //     fn getOrderTarget() -> Unit;
    //     fn getOrderTargetPosition() -> Position;
    //     fn getOrderTimer() -> i32;
    //     fn getPlagueTimer() -> i32;
    //     fn getPlayer() -> Player;
    ...
    //     fn getRegion() -> Region;
    //     fn getRemainingBuildTime() -> i32;
    //     fn getRemainingResearchTime() -> i32;
    //     fn getRemainingTrainTime() -> i32;
    //     fn getRemainingUpgradeTime() -> i32;
    //     fn getRemoveTimer() -> i32;
    //     fn getReplayID() -> i32;
    //     fn getResourceGroup() -> i32;
    //     fn getResources() -> i32;
    //     fn getRight() -> i32;
    //     fn getScarabCount() -> i32;
    //     fn getSecondaryOrder() -> Order;
    //     fn getShields() -> i32;
    //     fn getSpaceRemaining() -> i32;
    //     fn getSpellCooldown() -> i32;
    //     fn getSpiderMineCount() -> i32;
    //     fn getStasisTimer() -> i32;
    //     fn getStimTimer() -> i32;
    //     fn getTarget() -> Unit;
    ...
    //     fn getType() -> UnitType;
    //     fn getUnitsInRadius(radius: i32, pred: UnitFilter) -> Unitset;
    ...
    //     fn canCancelTrainSlotI(slot: i32, checkCanIssueCommandType: bool, checkCommandibility: bool) -> bool;
